export class LEDSign {
    constructor(scene, position, parkingLot, options = {}) {
        ...
        console.log("ParkingLot Objemi Kontrol Et:", this.parkingLot);
        console.log("Sınırlar:", this.parkingLot.x, this.parkingLot.width, this.parkingLot.startZ, this.parkingLot.endZ);
